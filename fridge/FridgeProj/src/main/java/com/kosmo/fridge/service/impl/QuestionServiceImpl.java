...
import com.kosmo.fridge.service.QuestionService;
...
public class QuestionServiceImpl implements QuestionService {
	...
	@Override
	public ListPagingData<QuestionDTO> selectList(Map map, HttpServletRequest req, int nowPage) {
		//페이징을 위한 로직 시작]
		//전체 레코드수	
