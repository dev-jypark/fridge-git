...
<link href="../../../../resources/css/memberinfo/Reward.css" rel="stylesheet" type="text/css">
<meta charset="UTF-8">
			...
			<nav class="page-navigation myhome-nav__owner">
				<ul style="transform: translateX(0px);">
					<li class="page-navigation__item"><a id="profile"
						class="active" href="/users/2522547" target="_self">리워드</a></li>
					<li class="page-navigation__item"><a id="setting" class=""
						href="/users/2522547/edit" target="_self">설정</a></li>
				</ul>
			</nav>
		</div>
	</div>
