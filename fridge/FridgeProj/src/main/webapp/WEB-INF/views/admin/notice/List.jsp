...
<div class="table-responsive">
                        ...
                        <c:if test="${not isEmpty}">
                            <c:forEach var="record" items="${records }" varStatus="loop">
                                <tr>
                                    ...
                                    <td class="text-left"><a href="<c:url value="/admin_notice/View.do?n_no=${record.n_no}&nowPage="/><c:out value="${param.nowPage }" default="1"/>">${record.n_title}</a></td>
                                    <td class="text-center col-md-1">${record.n_hit}</td>                                 
                                    <td class="text-center col-md-5">${record.n_postdate}</td>
                                </tr>
                            </c:forEach>
                        </c:if>
                    </table>
	...
	<div class="text-right">
		...
		<a href="<c:url value="admin_notice/Write.do"/>" class="btn btn-primary">등록</a>
	</div>
                <!-- 페이징 -->
