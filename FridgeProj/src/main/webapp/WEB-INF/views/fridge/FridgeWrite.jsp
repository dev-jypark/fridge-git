...
<script>
	...
	function sendData() {
		...
		$.ajax({
			url : "<c:url value="/fridge/insert.do"/>",
			type : 'post',
			dataType : 'text',
			data : formData,
			cache : false,
			...
			success : function(data, jqWHR, textStatus){
				...
				if(data){
					...
					alert("재료가 등록되었습니다!");
					location.href="/fridge/fridgeList.do";
				}
			}
		});
	}
							...
							<article class="commerce-cart__group">
								...
								<ul class="commerce-cart__group__item-list">
												...
												<li class="commerce-cart__delivery-group__product-item" id="hereDouble">
													...
													<section class="carted-product-copy" style="margin-bottom: 20px;display: flex;">
														...
														<div class="form-group"
															...
															<input type="text" class="form-control" placeholder="재료명" name="i_name" value="">
														</div>
														<!-- 수량 -->
									...
									<div class="commerce-cart__delivery-group__footer">
										...
										<button type="button" class="btn btn-default" onclick="location.href ='/fridge/fridgeList.do';">취소</button>
