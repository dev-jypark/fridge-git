      ...
      <div class="input-form col-md-12 mx-auto">
         ...
         <form method="post" action="SignUp.do" class="validation-form" novalidate="novalidate" name="login_frm">
            ...
            <div class="mb-3"> 
               ...
               <input type="password" pattern="(?=.*[a-zA-Z]+)(?=.*[0-9]+)(?=.*[`~!@@#$%^&*|₩₩₩'₩;:₩/?]+).{8,20}" class="form-control" id="pwd1" name="pwd" placeholder="비밀번호를 입력해주세요." onchange="pwdCheck()" required/> 
            ...
            style="background-color: #95E1D3; color: #FFFFFF; margin-top:10px" onclick="registerCheck()"
            >회원가입</button> 
         </form> 
      </div> 
   </div> 
