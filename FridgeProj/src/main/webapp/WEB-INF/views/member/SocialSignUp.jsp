	...
	<div class="input-form-backgroud row">
		<div class="input-form col-md-12 mx-auto">
			...
			<form method="post" action="SocialSignUp.do" class="validation-form" novalidate="novalidate" name="login_frm">
				<!-- 아이디 -->				
				<div class="mb-3"> 
					<input type="hidden" class="form-control" id="id" name="socialId" value="${param.socialId}" readonly="readonly" required/> 		
				</div> 
				 
				<!-- 이메일 -->				
				<div class="mb-3">
					<label class="lable" for="email">이메일</label>
					<input type="email" class="form-control" id="email" name="socialEmail" value="${param.socialEmail}" readonly="readonly" required/>				
				</div>
				<!-- 닉네임 -->
				<div class="mb-3"> 
					<label class="lable" for="nickname">별명</label>
					<div class="description">한글 2~8자</div>
					<input type="text" pattern="^[가-힣]{2,8}$" class="form-control" id="nick" name="socialNick" value="${param.socialNick}" 
					placeholder="사용하실 별명을 입력해주세요." required/> 
				...
				<div class="mb-3"> 
					...
					<input type="text" pattern="([가-힣\s]+(도|시|군)+[가-힣0-9\s]+(시|구|읍|면)+[가-힣0-9\s]+(리|동))" class="form-control" id="addr" name="addr" 
					placeholder="예) 서울시 강남구 개포1동, 달성군 다사읍 달천리" required/> 
