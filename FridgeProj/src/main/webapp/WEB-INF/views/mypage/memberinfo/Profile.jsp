...
<head>
	...
	<link href="<c:url value="/resources/css/memberinfo/Profile.css"/>" rel="stylesheet" type="text/css">
	<script src="<c:url value="/resources/js/memberinfo/Profile.js"/>"></script> 
	<meta charset="UTF-8">
