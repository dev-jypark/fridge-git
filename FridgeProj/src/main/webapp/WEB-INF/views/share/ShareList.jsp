...
<!-- <link rel="shortcut icon" href="images/ico/favicon.jpg">
	...
	<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/share/shareMap.css"/>">
...
<script type="text/javascript">
	...
	var modalAjax = function(data,id){
	    ...
	    var tableString='<article class="contents"><header class="top"><div class="user_container"><div class="profile_img"><img src="imgs/thumb.jpeg" alt="프로필이미지">'+
			...
			'<li class="list-item location">지역: <span>'+data.addr+'</span></li><a href="<c:url value="/chatlist.do"/>" class="btn btn-info">채팅</a></ul><div class="description">';
			//if()
