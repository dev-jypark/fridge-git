	                            ...
	                            <li class="dropdown">
	                                ...
	                                <div class="dropdown-menu">
	                                    <ul>
	                                        ...
	                                        <li><a href="<c:url value="/share/shareWrite.do"/>">글쓰기</a></li>
	                                    </ul>
	                                </div>
	                            </li>
	                            <li><a href="<c:url value='/recipepage.do'/>"><img src="<c:url value="/resources/images/top/top3.png"/>" alt="레시피" style="width:70%; height:70%;"/></a></li>                          
	                            <li class="dropdown">
