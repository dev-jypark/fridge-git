...
function recipe2(){
    location.href="http://192.168.35.89:9080/recipedetailTwo.do";
}
function recipe3(){
    location.href="http://localhost:9080/recipedetail3.do";
}
function recipe4(){
    location.href="http://localhost:9080/recipedetail4.do";
}
